...
# Model
model = torch.hub.load(r"C:\Users\Leo\Downloads\MachineLearning\yolov5", 
                       "custom", 
                       path=r"C:\Users\Leo\Downloads\MachineLearning\yolov5\runs\train\exp2\weights\best.pt", 
                       source="local").to(device)

# Images
# img = "C:/Users/Leo/Downloads/MachineLearning/robot_ur3e_yolov5/for_testing/photo_1718317391.jpg"  # or file, Path, PIL, OpenCV, numpy, list
img = r"C:\Users\Leo\Downloads\MachineLearning\robot_ur3e_yolov5\for_testing\coffee.png"
# Inference
results = model(img)
